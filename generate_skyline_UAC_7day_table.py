#!/usr/bin/env python3
"""
UAC Skyline 7-Day Hourly Weather Table Generator
======================================================
...
_DEFAULT_OUTPUT = os.path.join(os.path.dirname(__file__), "Skyline-UAC-7Day-Table.html")
...
def main():
    global OUTPUT_PATH
    parser = argparse.ArgumentParser(description="Generate Skyline UAC 7-day weather table HTML.")
