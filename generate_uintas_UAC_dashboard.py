#!/usr/bin/env python3
"""
UAC Uintas Weather Dashboard Generator
============================================
...
Cron example:
  0 6,18 * * * /usr/bin/python3 /path/to/generate_uintas_UAC_dashboard.py
...
_DEFAULT_OUTPUT = os.path.join(os.path.dirname(__file__), "Uintas-UAC-Weather-Stations.html")
...
def main():
    global OUTPUT_PATH
    parser = argparse.ArgumentParser(description="Generate Uintas UAC weather dashboard HTML.")
