...
Usage:
  python3 generate_uintas_weather_table.py
  python3 generate_uintas_weather_table.py --output /path/to/output.html
"""
...
_DEFAULT_OUTPUT = os.path.join(os.path.dirname(__file__), "uintas-weather-tables.html")
