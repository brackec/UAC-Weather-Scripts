...
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "Wasatch-Weather-Stations.html")
...
<head>
  ...
  <title>{REGION} — UAC Weather Stations</title>
...
<div class="page-header">
  <div>
    <h1>{REGION} &mdash; UAC Weather Stations</h1>
