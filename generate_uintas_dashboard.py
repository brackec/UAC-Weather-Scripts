...
# Example: /home2/vofgesmy/python/scripts/generate_uintas_dashboard.py
...
def write_refresh_php(output_html_path: str, server_script_path: str,
    ...
    php_path  = os.path.join(html_dir, "refresh-uintas.php")
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "/home2/vofgesmy/python/scripts/generate_uintas_dashboard.py). "
            "When set, writes a refresh-uintas.php helper alongside the HTML."
        ),
    )
    parser.add_argument(
        "--python-path",
    ...
    refresh_url = "refresh-uintas.php"
