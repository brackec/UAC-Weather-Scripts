...
Usage:
  python3 generate_uintas_7day_table.py
  python3 generate_uintas_7day_table.py --output /path/to/output.html
"""
...
_DEFAULT_OUTPUT = os.path.join(os.path.dirname(__file__), "Uintas-7Day-Table.html")
...
def write_refresh_php(output_html_path: str, server_script_path: str,
    ...
    php_path  = os.path.join(html_dir, "refresh-uintas-7day.php")

    php = """<?php
// Auto-generated by generate_uintas_7day_table.py
$python = """ + repr(python_path) + """;
$script = """ + repr(server_script_path) + """;
$output = __DIR__ . '""" + "/" + html_name + """';
$log    = __DIR__ . '/refresh-uintas-7day.log';
...
def main():
    ...
    parser.add_argument("--server-script-path", default=None,
                        help="Absolute path to this script on the server. "
                             "When set, writes a refresh-uintas-7day.php helper alongside the HTML.")
    ...
    refresh_url = "refresh-uintas-7day.php"
